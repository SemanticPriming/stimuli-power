...
```{r eval = F}
sim_mac <- readRDS("simulation_2022-08-15 06:40:46.Rdata")
sim_win <- readRDS("simulation_windows3.Rdata")
sim_linux <- readRDS("simulation_linux4.Rdata")

all_sim <- bind_rows(sim_mac, .id = "id") %>% 
  bind_rows(sim_win, .id = "id") %>% 
  bind_rows(sim_linux, .id = "id")
