...
for (i in 1:10){
  ...
  for (p in 1:10){
    ...
    samples <- simulate_samples(start = 20, stop = 100, increase = 5, 
  ...
  } # simulate the sample 100 times for each population 
  
} # simulate the population 100 times 

```


```{r}
# clean up the stuff from the summary 
