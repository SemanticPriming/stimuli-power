---
title: "Methods Power Study - Middle Simulations"
...
```{r eval = F}
all_sim <- bind_rows(readRDS("simulation_study/simulation_middle/simulation_2023-08-29_mac_middle.Rdata")) %>% unique()
...
```{r}
export(summary_long, "simulation_study/simulation_middle/simulated_summary_data_middle.csv", row.names = F)
```
