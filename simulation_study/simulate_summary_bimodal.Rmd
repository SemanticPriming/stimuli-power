...
```{r simulate-bimodal}
# simulate population 
normal_pops <- simulate_population(mu = 4, # item means
...
floor_pops <- simulate_population(mu = 2, # item means
  mu_sigma = .2, # variability in item means 
...
ceiling_pops <- simulate_population(mu = 6, # item means
  mu_sigma = .2, # variability in item means 
  sigma = 1, # item standard deviations
  sigma_sigma = .1, # standard deviation of the standard deviations
  number_items = 30, # number of items
...
# simulate sample 
item_number <- 1:30
prop_mix <- 1 # manipulated this number 
