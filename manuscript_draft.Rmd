...
In this procedure, we identified three points of simulation: the population, the samples from those populations, and the researcher sample simulation. In order to minimize any potentially random quirks, we ran each of these samples 100 times for a total of 1000000 simulations. The average of these simulations is presented in the results. 
