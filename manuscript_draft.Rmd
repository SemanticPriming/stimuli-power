...
```{r bimodal-results, fig.cap = "Estimated sample sizes for distributions that vary in the number of bimodal items. Note that percent below is treated as a continuous factor", fig.height=8, fig.width=8}
