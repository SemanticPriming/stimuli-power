...
## Special Consideration: Bimodal Data
...
```{r bimodal-figure, fig.cap = "Simulated example of Likert data with half of the items as bimodal distributions.", fig.height=8, fig.width=8}
...
ggplot(bi_DF, aes(x = percent_below,
  ...
  ylab("Corrected Sample Size") +
  scale_color_viridis_d(option = "plasma") +  # Use the 'plasma' viridis option
